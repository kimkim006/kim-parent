...
import com.kim.sp.service.SmsTemplateService;
 ...
 * @author liubo
 */
@OperateLog(module = SoftPhoneModule.SMS_TEMPLATE)
//@Controller
...
public class SmsTemplateController extends BaseController {
	...
	public ResultResponse listByPage(SmsTemplateVo vo){
		
		return new TableResponse(smsTemplateService.listByPage(vo));
	}
	...
	public ResultResponse list(SmsTemplateVo vo){
		
		return new ObjectResponse(true).data(smsTemplateService.list(vo));
	}
	*/
	...
	public ResultResponse find(SmsTemplateVo vo){

		SmsTemplateEntity entity = smsTemplateService.find(vo);
		if(entity != null){
	 ...
	 * @author liubo
	 */
	private String checkAddParam(SmsTemplateEntity entity) {
	...
	public ResultResponse add(@RequestBody SmsTemplateEntity entity) {
		...
		entity = smsTemplateService.insert(entity);
	 ...
	 * @author liubo
	 */
	private String checkParam(SmsTemplateEntity entity) {
	 ...
	 * @author liubo
	 */
	private String checkUpdateParam(SmsTemplateEntity entity) {
	...
	public ResultResponse update(@RequestBody SmsTemplateEntity entity) {
		...
		int n = smsTemplateService.update(entity);
	...
	public ResultResponse delete(@RequestBody SmsTemplateVo vo) {

		int n = smsTemplateService.delete(vo);
		return n > 0 ? new MsgResponse(MsgCode.SUCCESS) : new MsgResponse(MsgCode.FAIL).msg("该记录不存在或已删除");
	}
}